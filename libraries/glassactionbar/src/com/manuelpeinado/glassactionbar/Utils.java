...
public class Utils {
    public static Bitmap drawViewToBitmap(Bitmap dest, View view, int width, int height, int downSampling, Drawable drawable) {
        ...
        if (view instanceof GridView) {
            return getWholeGridViewItemsToBitmap((GridView) view);
        }
    ...
    public static Bitmap getWholeGridViewItemsToBitmap(GridView gridView) {
        ...
        Bitmap bigbitmap    = Bitmap.createBitmap(gridView.getMeasuredWidth(), allitemsheight, Bitmap.Config.ARGB_8888);
        ...
        for (int i = 0; i < bmps.size(); i++) {
            ...
            bigcanvas.drawBitmap(bmp, gridView.getMeasuredWidth() * (i % gridView.getNumColumns()) / gridView.getNumColumns(), iHeight, paint);
